...
void RPortCamera::Find(ara::com::ServiceHandleContainer<deepracer::service::camera::proxy::SvCameraProxy::HandleType> handles, ara::com::FindServiceHandle findHandle)
{
    ...
    else
    {
        ...
        m_interface = std::make_unique<deepracer::service::camera::proxy::SvCameraProxy>(handles[0]);
...
void RPortCamera::ReadDataCamEvent(ara::com::SamplePtr<deepracer::service::camera::proxy::events::CamEvent::SampleType const> samplePtr)
{
    ...
    if (m_receiverCamEvent)
    {
        m_receiverCamEvent(data);
    }
}
 
void RPortCamera::RegistEventHandlerCamEvent(std::function<void(const deepracer::service::camera::proxy::events::CamEvent::SampleType&)> handler)
{
    m_receiverCamEvent = handler;
}
