...
private:
    ...
    std::unique_ptr<sensorfusion::aa::port::PPortSensorFusion> m_PPortSensorFusion;
    
    /// @brief Instance of Port {SensorFusion.RPortCamera}
    std::unique_ptr<sensorfusion::aa::port::RPortCamera> m_RPortCamera;
    
    /// @brief Instance of Port {SensorFusion.RPortLidar}
    std::unique_ptr<sensorfusion::aa::port::RPortLidar> m_RPortLidar;
};
