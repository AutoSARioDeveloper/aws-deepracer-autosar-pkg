...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : inferece_skeleton.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_INFERECE_SKELETON_H
#define PARA_COM_GEN_SERVICE_INTERFACE_INFERECE_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    InfereceSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    /// @brief Destructor
    virtual ~InfereceSkeleton() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00134}
    InfereceSkeleton(const InfereceSkeleton& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00134}
    InfereceSkeleton& operator=(const InfereceSkeleton& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00135}
    InfereceSkeleton(InfereceSkeleton&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00135}
    InfereceSkeleton& operator=(InfereceSkeleton&& other) noexcept
    {
        mInterface = std::move(other.mInterface);
        TimingEvent_100ms = std::move(other.TimingEvent_100ms);
        mInterface->SetE2EErrorHandler([this](const ara::com::e2e::E2EErrorDomain& errorCode, ara::com::e2e::DataID dataID, ara::com::e2e::MessageCounter messageCounter) {
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_INFERECE_SKELETON_H