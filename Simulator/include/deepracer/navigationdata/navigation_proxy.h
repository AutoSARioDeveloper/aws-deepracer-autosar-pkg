...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : navigation_proxy.h
/// SERVICE INTERFACE NAME            : Navigation
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_NAVIGATION_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_NAVIGATION_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<NavigationProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<NavigationProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<NavigationProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<NavigationProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<NavigationProxy::HandleType> handleContainer;
    ...
    explicit NavigationProxy(HandleType& handle)
        : mHandle(handle)
    ...
    NavigationProxy(NavigationProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    NavigationProxy& operator=(const NavigationProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    NavigationProxy(NavigationProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    NavigationProxy& operator=(NavigationProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_NAVIGATION_PROXY_H