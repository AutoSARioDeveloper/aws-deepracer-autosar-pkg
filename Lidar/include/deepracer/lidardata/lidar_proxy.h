...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : lidar_proxy.h
/// SERVICE INTERFACE NAME            : Lidar
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_LIDAR_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_LIDAR_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<LidarProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<LidarProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<LidarProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<LidarProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<LidarProxy::HandleType> handleContainer;
    ...
    explicit LidarProxy(HandleType& handle)
        : mHandle(handle)
    ...
    LidarProxy(LidarProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    LidarProxy& operator=(const LidarProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    LidarProxy(LidarProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    LidarProxy& operator=(LidarProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_LIDAR_PROXY_H