...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : sensorfusion_skeleton.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_SENSORFUSION_SKELETON_H
#define PARA_COM_GEN_SERVICE_INTERFACE_SENSORFUSION_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    SensorFusionSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    /// @brief Destructor
    virtual ~SensorFusionSkeleton() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00134}
    SensorFusionSkeleton(const SensorFusionSkeleton& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00134}
    SensorFusionSkeleton& operator=(const SensorFusionSkeleton& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00135}
    SensorFusionSkeleton(SensorFusionSkeleton&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00135}
    SensorFusionSkeleton& operator=(SensorFusionSkeleton&& other) noexcept
    {
        mInterface = std::move(other.mInterface);
        TimingEvent_100ms = std::move(other.TimingEvent_100ms);
        mInterface->SetE2EErrorHandler([this](const ara::com::e2e::E2EErrorDomain& errorCode, ara::com::e2e::DataID dataID, ara::com::e2e::MessageCounter messageCounter) {
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_SENSORFUSION_SKELETON_H