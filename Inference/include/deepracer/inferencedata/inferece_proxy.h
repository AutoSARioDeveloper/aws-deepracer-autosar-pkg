...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : inferece_proxy.h
/// SERVICE INTERFACE NAME            : Inferece
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_INFERECE_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_INFERECE_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// INCLUSION HEADER FILES
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @uptrace{SWS_CM_01004}
#include "inferece_common.h"
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<InfereceProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<InfereceProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<InfereceProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<InfereceProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<InfereceProxy::HandleType> handleContainer;
    ...
    explicit InfereceProxy(HandleType& handle)
        : mHandle(handle)
    ...
    ~InfereceProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    InfereceProxy(InfereceProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    InfereceProxy& operator=(const InfereceProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    InfereceProxy(InfereceProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    InfereceProxy& operator=(InfereceProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_INFERECE_PROXY_H