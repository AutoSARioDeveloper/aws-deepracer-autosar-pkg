...
navigation::aa::Navigation* g_swcNavigation{nullptr};
 
static void SignalHandler(std::int32_t signal)
{
    if (signal == SIGTERM || signal == SIGINT)
    {
        g_swcNavigation->Terminate();
    }
}
...
int main(int argc, char *argv[], char* envp[])
{
    ...
    if (araInitialized)
    {
        ara::log::Logger& appLogger{ara::log::CreateLogger("NAVI", "Navigation's main function")};
        ...
        navigation::aa::Navigation swcNavigation;
        g_swcNavigation = &swcNavigation;
        
        // initialize software component
        proceed = swcNavigation.Initialize();
