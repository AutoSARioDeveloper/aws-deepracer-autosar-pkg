...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : svnavigation_proxy.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_SVNAVIGATION_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_SVNAVIGATION_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit NavEvent(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<SvNavigationProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<SvNavigationProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<SvNavigationProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<SvNavigationProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<SvNavigationProxy::HandleType> handleContainer;
    ...
    explicit SvNavigationProxy(HandleType& handle)
        : mHandle(handle)
    ...
    ~SvNavigationProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    SvNavigationProxy(SvNavigationProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    SvNavigationProxy& operator=(const SvNavigationProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    SvNavigationProxy(SvNavigationProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    SvNavigationProxy& operator=(SvNavigationProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_SVNAVIGATION_PROXY_H