...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : svcamera_proxy.h
/// SERVICE INTERFACE NAME            : SvCamera
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_SVCAMERA_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_SVCAMERA_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// INCLUSION HEADER FILES
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @uptrace{SWS_CM_01004}
#include "svcamera_common.h"
...
public:
    ...
    using SampleType = deepracer::serviceinterfacecam::StereoCamera;
    /// @brief Constructor
    explicit CamEvent(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
    virtual ~CamEvent() = default;
    /// @brief Delete copy constructor
    CamEvent(const CamEvent& other) = delete;
    /// @brief Delete copy assignment
    CamEvent& operator=(const CamEvent& other) = delete;
    /// @brief Move constructor
    CamEvent(CamEvent&& other) noexcept : mInterface(other.mInterface)
    {
    ...
    CamEvent& operator=(CamEvent&& other) noexcept
    {
...
private:
    ...
    const std::string kCallSign = {"CamEvent"};
};
} /// namespace events
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<SvCameraProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<SvCameraProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<SvCameraProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<SvCameraProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<SvCameraProxy::HandleType> handleContainer;
    ...
    explicit SvCameraProxy(HandleType& handle)
        : mHandle(handle)
        , mInterface(std::make_unique<para::com::ProxyInterface>(handle.GetInstanceSpecifier(), handle.GetServiceHandle()))
        , CamEvent(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~SvCameraProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    SvCameraProxy(SvCameraProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    SvCameraProxy& operator=(const SvCameraProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    SvCameraProxy(SvCameraProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , CamEvent(std::move(other.CamEvent))
    {
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    SvCameraProxy& operator=(SvCameraProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
public:
    /// @brief - event, CamEvent
    events::CamEvent CamEvent;
};
} /// namespace proxy
} /// namespace camera
} /// namespace service
} /// namespace deepracer
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_SVCAMERA_PROXY_H