...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : camera_proxy.h
/// SERVICE INTERFACE NAME            : Camera
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_CAMERA_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_CAMERA_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<CameraProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<CameraProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<CameraProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<CameraProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<CameraProxy::HandleType> handleContainer;
    ...
    explicit CameraProxy(HandleType& handle)
        : mHandle(handle)
    ...
    CameraProxy(CameraProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    CameraProxy& operator=(const CameraProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    CameraProxy(CameraProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    CameraProxy& operator=(CameraProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_CAMERA_PROXY_H