...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : camera_skeleton.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_CAMERA_SKELETON_H
#define PARA_COM_GEN_SERVICE_INTERFACE_CAMERA_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    CameraSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    /// @brief Destructor
    virtual ~CameraSkeleton() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00134}
    CameraSkeleton(const CameraSkeleton& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00134}
    CameraSkeleton& operator=(const CameraSkeleton& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00135}
    CameraSkeleton(CameraSkeleton&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00135}
    CameraSkeleton& operator=(CameraSkeleton&& other) noexcept
    {
        mInterface = std::move(other.mInterface);
        TimingEvent_100ms = std::move(other.TimingEvent_100ms);
        mInterface->SetE2EErrorHandler([this](const ara::com::e2e::E2EErrorDomain& errorCode, ara::com::e2e::DataID dataID, ara::com::e2e::MessageCounter messageCounter) {
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_CAMERA_SKELETON_H